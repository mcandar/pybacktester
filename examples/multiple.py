...
from strategy_tester.asset import Currency
...
eurusd = Currency(price=generate_data(100000), base="EUR", quote="USD")
account = Account()

strategy_1 = Strategy(
    RiskManagement=ConstantRate(0.05), id=23030, name="noise_trader_1"
)
strategy_2 = Strategy(
    RiskManagement=KellyCriterion(n=20), id=23031, name="noise_trader_2"
)
